...
if (!debug) {
  ...
  const packer = new Packer([{data:script,type:'js',action:'eval'}],{allowFreeVars:true,modelRecipBaseCount:21,modelMaxCount:4,numAbbreviations:32,sparseSelectors:[0,1,2,3,5,6,7,8,13,25,42,49,74,193,385,396],precision:16,recipLearningRate:1910});
